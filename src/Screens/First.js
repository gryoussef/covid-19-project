...
render(){
    return(
        ...
        style={styles.container}>
            ...
            <Text style={styles.text}>Est ce que vous voulez que vous soyez </Text>
           ...
           <View style={{flexDirection:'row'}}><Text style={[styles.text,{color:'#66B2C0'}]}>StayAtHome</Text><Text style={styles.text}>vous aide à contacter les</Text></View> 
